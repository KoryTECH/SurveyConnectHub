...
export default function PostJobPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (parseFloat(formData.budget) < 1) {
			setError("Budget must be greater than 0");
			return;
		}
		if (parseFloat(formData.budget) > 30000) {
			setError(
				"Budget cannot exceed $30,000. For larger contracts, please contact us at support@SurveyConnectHub.com to arrange payment.",
			);
			return;
		}
							...
							<div>
								...
								<div className="relative">
									...
									<input
										...
										min="1"
										max="30000"
										className="w-full pl-8 pr-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-900 dark:text-white bg-white dark:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-500 dark:placeholder-gray-400"
									/>
								</div>
